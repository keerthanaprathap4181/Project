...
{
  extract($_POST);
  $qq="insert into feedback values(null,'$patientid','$feed',now())";
  insert($qq);
  alert("Feedback added");
  return redirect("patient_send_feedback.php");
}
}
...
<div class="left-content">
    ...
    <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="patient_home.php">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
                                    ...
                                    <div class="widget widget-report-table">
                                        ...
                                        <div class="row m-0 md-bg-grey-100 p-l-20 p-r-20">
                                            <div class="card-header">
                                              <h3 style="font-style: italic;font-family: monospace;">Send Feedback</h3>
                                        ...
                                        <table class="table">
                                            <tr>
                <th style="color: black;font-style: italic;font-family: monospace;">Feedback</th>
                <td style="color: black"><textarea name="feed" cols="60" rows="15"></textarea></td>
            </tr>
                                                    <tr>
                                                      <td colspan="2" align="center"><input type="submit" name="send" class="btn btn-success"></td>
                                                    </tr>
