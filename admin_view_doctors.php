...
{
  extract($_POST);
  $qq="SELECT *,CONCAT(first_name,' ',last_name) AS doctor_name FROM `doctors` INNER JOIN login USING (login_id) WHERE `status`='1' AND first_name LIKE '%$item%'";
}
 ?>
...
<?php
  ...
  <form method="post">
    <table class="table" style="width: 400px">
      <tr>
        <th><input type="text" name="item" class="form-control" placeholder="Search here"></th>
...
<center>
<br><br><br>
<p><a  href="admin_print_doctor.php" class="buttonA">PRINT</a></p>
