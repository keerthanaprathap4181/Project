...
{
  extract($_POST);
  $q="update patients set first_name='$fname',last_name='$lname',phone='$phone',email='$email',house_name='$hn',place='$place',gender='$gn',blood_group='$bg',place='$place' where login_id='$lid'";
  update($q);
...
<div class="left-content">
    ...
    <ol class="breadcrumb">
                <li class="breadcrumb-item"><a style="font-size: 30px;font-style: italic;font-family: monospace;" href="patient_home.php">Welcome, <?php echo $_SESSION['name'] ?></a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
...
<!--photoday-section--> 
                    ...
                    <?php 
$q1="select * from patients where login_id='$lid'";
$r=select($q1);
 ...
 ?>
                ...
                <td style="color: black"><input type="text" value="<?php echo $r[0]['first_name'] ?>" style="text-transform:capitalize;" name="fname" required class="form-control"></td>
            </tr>
            <tr>
                <th style="color: black">LastName</th>
                <td style="color: black"><input type="text"  value="<?php echo $r[0]['last_name'] ?>" style="text-transform:capitalize;" name="lname" required class="form-control"></td>
            </tr>
            <tr>
                <th style="color: black">Phone</th>
                <td style="color: black"><input type="text" value="<?php echo $r[0]['phone'] ?>"  minlength="10" maxlength="10" pattern="[6-9]{1}[0-9]{9}" name="phone" required class="form-control"></td>
            </tr>
            <tr>
                <th style="color: black">Email</th>
                <td style="color: black"><input type="email" value="<?php echo $r[0]['email'] ?>"  name="email" required class="form-control"></td>
            </tr>
            <tr>
                <th style="color: black">Date Of Birth</th>
                <td style="color: black"><input type="date" id="newDate" value="<?php echo $r[0]['dob'] ?>" checkDateTime="" max="<?php echo $res[0]['m'] ?>" name="dob" required class="form-control"></td>
            </tr>
            <tr>
                <th style="color: black">Gender</th>
                <td style="color: black"><input type="radio" name="gn" required  value="male">Male
<input type="radio" name="gn" required  value="female">Female

                </td>
            </tr> 
            <tr>
                <th style="color: black">House Name</th>
                <td style="color: black"><input type="text" value="<?php echo $r[0]['house_name'] ?>" style="text-transform:capitalize;" name="hn" required class="form-control"></td>
            </tr>
            <tr>
                <th style="color: black">Blood Group</th>
                <td style="color: black"><select name="bg" required="" class="form-control">
            ...
            <tr>
                ...
                <td style="color: black"><input type="text" value="<?php echo $r[0]['place'] ?>" style="text-transform:capitalize;" name="place" required class="form-control"></td>
            </tr>
                                                    <tr>
