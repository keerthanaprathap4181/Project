...
if (isset($_POST['payment'])) {
	extract($_POST);
	$q="insert into payments values(null,'$id','$amount',curdate(),'doctor')";
	insert($q);
	$q2="update bookings set status='Paid' where book_id='$id'";
	update($q2);
	alert("paid successfully");
	return redirect("patient_view_bookings.php");
...
<form method="POST">
<center>
				<h2 style="color: black;margin-top: 1em;">Make Payment<span class="text_color"></span> </h2>

<table class="table" style="width:500px;">
			<tr>
					<th style="color: black">CardNo</th>
					<td style="color: black"><input type="text" name="" required class="form-control"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="color: black"><input type="text" name="amount" value="<?php echo $amt ?>"  required  class="form-control"></td>
				</tr>
				<tr>
